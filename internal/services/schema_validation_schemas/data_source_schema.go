...
var _ datasource.DataSourceWithConfigValidators = (*SchemaValidationSchemasDataSource)(nil)
...
func (d *SchemaValidationSchemasDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *SchemaValidationSchemasDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
	return []datasource.ConfigValidator{
		datasourcevalidator.ExactlyOneOf(path.MatchRoot("schema_id"), path.MatchRoot("filter")),
	}
}
